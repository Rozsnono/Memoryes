...
export default function RootPage() {
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center bg-memoryes-background">
      ...
      >
        <Heart className="text-memoryes-primary fill-memoryes-primary" size={40} />
      </motion.div>
      ...
      <motion.h1
        ...
        className="text-3xl font-serif italic text-memoryes-clay"
      >
        Memoryes
      </motion.h1>

      <div className="absolute bottom-12">
        <div className="w-1 h-1 bg-memoryes-primary rounded-full animate-ping" />
      </div>
    </div>
  );
}