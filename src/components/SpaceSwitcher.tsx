    ...
    return (
        <div className="relative">
            ...
            >
                ...
                />
                <span className="text-sm font-serif italic text-memoria-clay truncate max-w-[100px]">
                                ...
                                {!isCreating ? (
                                    ...
                                    >
                                        <div className="flex justify-between items-center mb-4">
                                            <h3 className="text-[10px] font-black text-memoria-clay uppercase tracking-widest">Name your vault</h3>
                                        ...
                                        <input
                                            ...
                                            className="w-full p-4 bg-slate-50 rounded-2xl outline-none border border-transparent focus:border-memoria-primary text-sm font-medium mb-3"
                                        />

                                        <button
                                            onClick={handleCreateSpace}
                                            disabled={loading || !newSpaceName}
                                            className="w-full bg-memoria-clay text-white py-3 rounded-2xl font-bold text-xs flex items-center justify-center gap-2 shadow-lg disabled:opacity-50"
                                        >
